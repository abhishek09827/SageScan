...
## Resume Phrasing (copy-paste ready)
Generated from your actual numbers:

BULLET 1: "Built SageScan, a CLI data quality tool (Go+Python, PyPI published) validating 125,547 rows/sec - 0.3x faster than Great Expectations with 100% violation recall across 17 check types"
BULLET 2: "Implemented KS test + PSI drift detection detecting distribution shifts >=1 sigma with 100% accuracy and <0% false positive rate"
BULLET 3: "Designed chunked file processing supporting 2GB+ datasets with 599MB peak memory via Go-Python JSON bridge"